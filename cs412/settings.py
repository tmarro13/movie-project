...
SECRET_KEY = 'django-insecure-1tzvz9fk_xomteh5*444ja9x1)lriut#=-xqq9697uc7e39g%s'
...
LOGIN_REDIRECT_URL = '/project/'  # Redirect after successful login
LOGOUT_REDIRECT_URL = '/project/'  # Redirect after logout
